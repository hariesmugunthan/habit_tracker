...
- Created the first Flutter project inside the `day0` folder.
- Ran the Flutter application successfully in Google Chrome using `flutter run -d chrome`.

## What I learned

- Flutter is a cross-platform UI framework that uses Dart.
- Flutter applications are built using widgets.
- The Flutter SDK provides the tools required to develop Flutter applications.
- Flutter can target the web, allowing the application to run in Chrome.
