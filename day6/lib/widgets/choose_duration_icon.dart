...
class _ChooseDurationIconState extends State<ChooseDurationIcon> {
  ...
  final List<String> durations = ['Daily', 'Weekdays', 'Weekends', 'Custom'];
        ...
        decoration: BoxDecoration(
          gradient: isSelected
              ? const LinearGradient(
                  ...
                  colors: [
                    Color(0xFFFFB27D), // Light orange - top
                    Color(0xFFFF936F), // Middle
                    Color(0xFFFF6F63), // Darker coral - bottom
                  ],
                )
              : null,
